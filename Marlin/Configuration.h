...
#define STRING_CONFIG_H_AUTHOR "(dcm, feb21_2021)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 5, 5, 25 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1, 3, 3, 10000 }
...
#define DEFAULT_TRAVEL_ACCELERATION   3    // X, Y, Z acceleration for travel (non printing) moves
